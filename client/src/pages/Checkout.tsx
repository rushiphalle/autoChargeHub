  ...
  const handlePay = async () => {
    ...
    try {
      ...
      if (paymentMethod === 'cod') {
        await axios.put(`http://localhost:5000/api/bookings/${booking._id}/payment-status`, {
          status: 'pending',
          method: 'cod'
        });
      ...
      if (!clientSecret) {
        const intent = await axios.post(`http://localhost:5000/api/payments/create-payment-intent`, {
